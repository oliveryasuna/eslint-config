/* eslint-disable */
/* prettier-ignore */
// Generated by scripts/typegen.ts — DO NOT EDIT.
...
export interface RuleOptions {
  ...
  /**
   * Require each argument (and the closing parenthesis) on its own line when a call spans multiple lines and has more than one argument
   */
  'custom/multiline-arguments'?: Linter.RuleEntry<[]>
  /**
   * Require each parameter (and the closing parenthesis) on its own line when a function has more than one parameter
   */
  'custom/one-parameter-per-line'?: Linter.RuleEntry<[]>
  /**
